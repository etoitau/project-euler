...
# by moving left, right, up, and down in matrix.txt 
# (right click and "Save Link/Target As..."), a 31K text 
...
def load_matrix() -> List[List[int]]:
    ...
    with open(os.path.join(__location__, "p083_matrix.txt")) as f:
        for input in f:
...
if __name__ == '__main__':
    ...
    print(solve(m)) # 425185
    print(time.time() - start) # 0.149 sec
